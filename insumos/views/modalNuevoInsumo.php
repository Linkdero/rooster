    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="card-body card-body-slide" width="100%" height="100%">
                    <div class="form-row">
                        ...
                        <input type="hidden" v-model="nombreMateriaPrima" id="nombreSelectMateriasPrimas" class="btn btn-outline-primary form-control btn-xs" value="" />
                    </div>
                </div>
            </div>
            <div class="modal-footer" style="margin-bottom: -1rem;">
                ...
                <button type="button" class="btn btn-primary btn-xs" :disabled="!camposCompletos" @click="setNuevoInsumo()">Generar Insumo <i class="fa-solid fa-octagon-plus ml-1"></i></button>
            </div>
        </div>
    </div>
</div>