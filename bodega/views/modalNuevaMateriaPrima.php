<div ref="idModal" id="setNuevoInsumo" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog"
    aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header" style="padding: .5rem .5rem;">
                <h5 class="modal-title text-primary" id="myModalLabel">{{nombreInsumos}}<i
                        class="fa-solid fa-rectangle-list ml-2"></i></h5>
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span></button>
            </div>
            <div class="modal-body">
                <div class="card-body card-body-slide" width="100%" height="100%">
                    <div v-if="tipoModal==1" class="form-row">
                        <div class="col-12">
                            <div class="x_title">
                        ...
                        <div class="input-group">
                            ...
                            <div class="col">
                                ...
                                <input type="number" v-model="existencia"
                                    class="btn btn-outline-primary form-control btn-xs" @click="actualizarInputs()" />
                            </div>
                        </div>
                        <div class="col">
                        ...
                        <input type="hidden" v-model="medida" id="idSelectMedidas"
                            class="btn btn-outline-primary form-control btn-xs" value="" />
                    </div>
            ...
            <div class="modal-footer" style="margin-bottom: -1rem;">
                ...
                <button v-if="tipoModal==1" type="button" class="btn btn-primary btn-xs" :disabled="!camposCompletos"
                    @click="generarInsumo()">Generar Materia Prima <i class="fa-solid fa-octagon-plus ml-1"></i></button>
                <button v-if="tipoModal==2" type="button" class="btn btn-primary btn-xs" :disabled="!camposCompletos2"
                    @click="ingresarBodega()">Ingresar Materia Prima <i class="fa-solid fa-octagon-plus ml-1"></i></button>
            </div>
        </div>
    </div>
</div>