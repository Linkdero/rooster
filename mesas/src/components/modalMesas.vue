                    ...
                    <div v-if="tipo == 1 || tipo == 3 || tipo == 4">
                        <div class="form-row">
                            ...
                            <div class="input-group">
                                ...
                                <listado-combos v-if="seleccionComidas == 3" :tipo="2" :modal="idModal"
                                    :evento="evento"></listado-combos>


                                <listado-alimentos v-if="seleccionComidas == 4" :tipo="1" :modal="idModal"
                                    :evento="evento"></listado-alimentos>

                                <div v-if="validarEquivalencia && tipo != 4">
                                    <div class="col">
                                ...
                                <div v-show="estadoEquivalencia" class="col">
                                    <listado-equivalencias :tipo="1" :modal="idModal"
