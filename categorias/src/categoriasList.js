let menusList = new Vue({
    ...
    methods: {
                        ...
                        "aoColumns": [
                            ...
                            { "class": "text-center", mData: 'menu' },
                            {
                                ...
                                render: function (data, type, row) {
                                    ...
                                    let encabezado = `
                                        <button class="btn btn-primary btn-xs" type="button" aria-haspopup="true" aria-expanded="false" onclick="getSubMenus()">
                                        Sub Menús <i class="fa-solid fa-rectangle-list"></i>
                                        </button>`;
                                    encabezado;
        ...
        baseTables: function () {
            ...
            $('#tblMenus').on('click', '.badge-success', function () {
                let id = $(this).data('id');
                that.setMesa(id, 1);
            });

            $('#tblMenus').on('click', '.badge-danger', function () {
                let id = $(this).data('id');
                that.setMesa(id, 2);
            });
        },
